	...
	gallery: [
		{
			...
			description: 'State-of-the-art industrial operations powered by precision equipment and professional expertise.',
		},
		{
			slot: 'Photo 02',
			...
			description: 'Specialized pumps and valves engineered for demanding industrial environments.',
		},
		{
			slot: 'Photo 03',
			...
			description: 'Comprehensive electrical solutions for seamless industrial operations.',
		},
		{
			slot: 'Photo 04',
			...
			description: 'Expert installation and commissioning ensuring optimal equipment performance.',
		},
		{
			slot: 'Photo 05',
			...
			description: 'Professional equipment installations engineered for reliable industrial operations.',
		},
		{
			slot: 'Photo 06',
			...
			description: 'Solutions built to the highest standards for mission-critical applications.',
		},
	],
